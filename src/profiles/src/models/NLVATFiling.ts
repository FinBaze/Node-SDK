...
import type { GetNLVatData200Response } from './GetNLVatData200Response';
import {
    GetNLVatData200ResponseFromJSON,
    GetNLVatData200ResponseFromJSONTyped,
    GetNLVatData200ResponseToJSON,
    GetNLVatData200ResponseToJSONTyped,
} from './GetNLVatData200Response';
...
export interface NLVATFiling {
    ...
    /**
     * 
     * @type {GetNLVatData200Response}
     * @memberof NLVATFiling
     */
    data: GetNLVatData200Response;
    /**
     * 
     * @type {Date}
     * @memberof NLVATFiling
...
export function NLVATFilingFromJSONTyped(json: any, ignoreDiscriminator: boolean): NLVATFiling {
    ...
    return {
        ...
        'to': (new Date(json['to'])),
        'data': GetNLVatData200ResponseFromJSON(json['data']),
...
export function NLVATFilingToJSONTyped(value?: Omit<NLVATFiling, 'id'|'updated'|'created'> | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': GetNLVatData200ResponseToJSON(value['data']),
    };
}
